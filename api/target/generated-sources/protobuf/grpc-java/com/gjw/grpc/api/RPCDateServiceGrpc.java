...
public final class RPCDateServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.gjw.grpc.api.RPCDateService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.gjw.grpc.api.RPCDateRequest,
      com.gjw.grpc.api.RPCDateResponse> METHOD_GET_DATE =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "com.gjw.grpc.api.RPCDateService", "getDate"),
          io.grpc.protobuf.ProtoUtils.marshaller(com.gjw.grpc.api.RPCDateRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(com.gjw.grpc.api.RPCDateResponse.getDefaultInstance()));
  ...
  public static abstract class RPCDateServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getDate(com.gjw.grpc.api.RPCDateRequest request,
        io.grpc.stub.StreamObserver<com.gjw.grpc.api.RPCDateResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.gjw.grpc.api.RPCDateRequest,
                com.gjw.grpc.api.RPCDateResponse>(
  ...
  public static final class RPCDateServiceBlockingStub extends io.grpc.stub.AbstractStub<RPCDateServiceBlockingStub> {
    ...
    /**
     */
    public com.gjw.grpc.api.RPCDateResponse getDate(com.gjw.grpc.api.RPCDateRequest request) {
  ...
  public static final class RPCDateServiceFutureStub extends io.grpc.stub.AbstractStub<RPCDateServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.gjw.grpc.api.RPCDateResponse> getDate(
        com.gjw.grpc.api.RPCDateRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_DATE:
          serviceImpl.getDate((com.gjw.grpc.api.RPCDateRequest) request,
              (io.grpc.stub.StreamObserver<com.gjw.grpc.api.RPCDateResponse>) responseObserver);
          break;
        default:
  ...
  private static final class RPCDateServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.gjw.grpc.api.RPCDateServiceApi.getDescriptor();
    }
  }
